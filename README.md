...
# Setup
## No need to mess with the database, it's very easy to set up as the data is in the computer memory. Estimated memory dwell time of encrypted message 0.1 seconds
### 1- Install Python
